                        ...
                        <div style="margin-right: 50px;" class="tpl-portlet-input tpl-fz-ml">
                            <div class="portlet-input input-small input-inline">
                                <select data-am-selected="{btnSize: 'sm'}" onchange="window.location=this.value;">
                                    ...
                                    <option value="/admin/discuss/bad" selected="selected">差评</option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="am-fr">
                                <ul class="am-pagination tpl-pagination">
                                    ...
                                    <#else>
                                        ...
                                        <#else>
                                            <li><a href="bad?page=${currentPage-1}&size=${size}">«</a>
                                            </li>
                                        </#if>
                                    ...
                                    <#-- 如果页数超过3页 -->
                                        <#if orderDiscussPage.getTotalPages() gt 3>
                                            <#if (currentPage - 1 gt 1 && currentPage + 1 lt orderDiscussPage.getTotalPages())>
                                                <li><a href="#">...</a></li>
                                                <li>
                                                    <a href="bad?page=${currentPage-1}&size=${size}">${currentPage-1}</a>
                                                </li>
                                                <li class="am-active"><a
                                                            href="bad?page=${currentPage}&size=${size}">${currentPage}</a>
                                                </li>
                                                <li>
                                                    <a href="bad?page=${currentPage+1}&size=${size}">${currentPage+1}</a>
                                                </li>
                                            ...
                                            <#elseif currentPage - 1 lte 1>
                                                <#list 1..3 as num>
                                                    ...
                                                    <#else>
                                                        <li>
                                                            <a href="bad?page=${num}&size=${size}">${num}</a>
                                                        </li>
                                                    </#if>
                                                </#list>
                                                <li><a href="#">...</a></li>
                                        ...
                                        <#else>
                                            <#list 1..orderDiscussPage.getTotalPages() as index>
                                                ...
                                                <#else>
                                                    <li>
                                                        <a href="bad?page=${index}&size=${size}">${index}</a>
                                                    </li>
                                                </#if>
                                            </#list>
                                        </#if>
