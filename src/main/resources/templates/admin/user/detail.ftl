        ...
        <div class="tpl-page-container tpl-page-header-fixed">
            ...
            <div class="tpl-content-wrapper">
                ...
                <ol class="am-breadcrumb">
                    ...
                    <li class="am-active">顾客详情</li>
                </ol>
                <div class="tpl-portlet-components">
                    <div class="portlet-title">
                        <div class="caption font-green bold">
                            <span class="am-icon-code"></span> 顾客详情
                        </div>
                    </div>
                            ...
                            <div class="am-u-sm-12 am-u-md-9">
                                <form class="am-form am-form-horizontal">
                                    <div class="am-form-group">
                                        <label for="order-master-id" class="am-u-sm-3 am-form-label">用户openid</label>
                                        <div class="am-u-sm-9">
                                            <input disabled="disabled" type="text" id="order-master-id"
                                                   value="${(userInfo.getUserOpenid())!""}">
                                        </div>
                                    </div>

                                    <div class="am-form-group">
                                        <label for="order-master-id" class="am-u-sm-3 am-form-label">用户名</label>
                                        <div class="am-u-sm-9">
                                            <input disabled="disabled" type="text" id="order-master-id"
                                    ...
                                    <div class="am-form-group">
                                        <label for="order-master-id" class="am-u-sm-3 am-form-label">订单总数</label>
                                        <div class="am-u-sm-9">
                                            <input disabled="disabled" type="text" id="order-master-id"
                                                   value="${(orderNum)!""}">
                                        </div>
                                    ...
                                    <div class="am-form-group">
                                        <label for="order-master-id" class="am-u-sm-3 am-form-label">订单总金额</label>
                                        <div class="am-u-sm-9">
                                            <input disabled="disabled" type="text" id="order-master-id"
                                    ...
                                    <table class="am-table am-table-striped am-table-hover table-main">
                                        ...
                                        <tbody>
                                            <#list orderDTOList as OrderDTO>
                                                <tr>
                                                    <td>
                                                        <a href="/admin/order/detail?orderId=${OrderDTO.getOrderId()}">
                                                            ${OrderDTO.getOrderId()}
                                                        </a>
                                                    </td>
                                                    ...
                                                    <td style="width: 200px">${OrderDTO.getCreateTime()}</td>
                                                </tr>
                                            </#list>
                                        </tbody>
                                    </table>
