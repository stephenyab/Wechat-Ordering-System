    ...
    <body>
        ...
        <div class="top">
            ...
            <div class="top_header header_active">
                <a href="/chief/index" style="color:#f63;">
                    <p>订单列表</p>
                </a>
            </div>

            <div class="top_header">
                <a href="/chief/cook/list" style="color: black">
                    <p>正在烹饪</p>
                </a>
            </div>
        ...
        <div class="main" style="margin-top: 50px">
            <#list orderDTOList as orderDTO>
                ...
                <div class="style5">
                    <div class="style6">
                        <a href="/chief/cook/cooking?orderId=${orderDTO.getOrderId()}">
        ...
        <script>
            ...
            if ('WebSocket' in window) {
                webSocket = new WebSocket('ws://${webSocketUrl}/webSocket/chief');
            } else {
